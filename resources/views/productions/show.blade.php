    ...
    <div class="max-w-7xl w-4/5 mx-auto mt-6 bg-white p-6 border border-gray-400 rounded-md shadow-md">
        <div class="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div class="w-full md:w-1/2">
                ...
                @php
                $configItemIds = collect($production->cameraConfigs)->flatMap(function($cc){
                return collect([
                $cc->item_id,
                $cc->lens,
                $cc->tripod,
                $cc->tripod_head,
                $cc->large_lens_adapter,
                ...
                <ul class="list-disc pl-5 space-y-3">
                    ...
                    <li class="flex items-center">
                        <span class="flex-1">@continue($configItemIds->contains($item->id)) {{-- ausblenden, wenn in Konfig enthalten --}}
                    <li>{{ $item->bezeichnung }} (ID {{ $item->id }})</li></span>
