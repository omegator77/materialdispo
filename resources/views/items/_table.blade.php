        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-100 border-b">
                <tr>
                    ...
                    <th class="text-left px-4 py-3">
                        <a href="{{ route('items.index', array_merge(request()->all(), ['sort_by' => 'rent_start', 'sort_direction' => request('sort_direction') == 'asc' ? 'desc' : 'asc'])) }}"
                           class="hover:text-orange-500">
                            Miete von
                        </a>
                    </th>
                    ...
                    <th class="text-left px-4 py-3">
                        <a href="{{ route('items.index', array_merge(request()->all(), ['sort_by' => 'rent_end', 'sort_direction' => request('sort_direction') == 'asc' ? 'desc' : 'asc'])) }}"
                           class="hover:text-orange-500">
                            Miete bis
                        </a>
                    </th>
